...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_AVG_COUNT" -parent ${Page_0}


}

proc update_PARAM_VALUE.C_AVG_COUNT { PARAM_VALUE.C_AVG_COUNT } {
	# Procedure called to update C_AVG_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AVG_COUNT { PARAM_VALUE.C_AVG_COUNT } {
	# Procedure called to validate C_AVG_COUNT
	return true
}
...
proc update_MODELPARAM_VALUE.C_AVG_COUNT { MODELPARAM_VALUE.C_AVG_COUNT PARAM_VALUE.C_AVG_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_AVG_COUNT}] ${MODELPARAM_VALUE.C_AVG_COUNT}
}
